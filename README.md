...
```
yarn add https://github.com/muxinc/mux-stats-sdk-react-native-video#0.1.0-beta.1
```

OR

```
npm install https://github.com/muxinc/mux-stats-sdk-react-native-video#0.1.0-beta.1 --save
```
